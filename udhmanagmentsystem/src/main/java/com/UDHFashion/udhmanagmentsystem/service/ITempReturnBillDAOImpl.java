...
public class ITempReturnBillDAOImpl implements TempReturnBillDAO {
	...
	@Override
	public boolean updateBillDetails(TempBill tempBill) {

		int updateShop = jdbcTemplate.update(CommonConstants.UPDATE_TEMP_RETURN_BILL_DETAILS, tempBill.getDate(),
				tempBill.getCashireId(), tempBill.getGrossAmount(), tempBill.getNetAmount(),
				tempBill.getTotalDiscount(), tempBill.getBalance(), tempBill.getNoOfItem(), tempBill.getId());
